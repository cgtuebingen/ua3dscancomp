...
def main():
    ...
    lmdb_path = "/graphics/scratch2/staff/zakeri/LMDBs/ABC_128cube_100KLMDB_Train_cuda/_with_NonOptimizedLatentCodes/"
    dataset = ABCWITHNONOPTIMIZEDLATENTCODES(obj_dir, lmdb_path, "",1, 128)
