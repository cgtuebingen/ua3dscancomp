...
class TESTLMDBOBJAVERSEPARTIALVIEWS(pl.LightningDataModule):
    def __init__(self, mesh_dir: str, views_dict_path: str, lmdb_path: str, res_dir: str, image_resolution: int, num_views: int, resolution: int, device='cuda:0'):
    ...
    def __getitem__(self, idx: int):
        ...
        combined_uncertainty_reshaped_normalized = (combined_uncertainty_reshaped / 50) - 1  # the input is [0, 100], -> normalize to [-1, 1]
