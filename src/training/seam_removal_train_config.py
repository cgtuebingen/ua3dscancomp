...
def main(eval_root: str):
    ...
    parser.add_argument("--num_views_for_test", default=3, type=int)

    parser.add_argument(
        "--first_transformer_ckpt",
        default="/path_to_shape_completion_checkpoint/",
        type=str,
        required=True,
    )
    ...
    model = RemoveSeams(
        ...
        first_transformer_ckpt=args.first_transformer_ckpt,
    )
